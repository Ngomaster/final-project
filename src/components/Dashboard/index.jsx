            ...
            <main className='main_dash'>
                <div className='container_items'>
                    ...
                    <div className='table_order'>
                        ...
                        <p id='line'>______________________________________________________________________________</p>
                        <table>
                            <thead>
                                <tr>
                                    <th>ID đơn hàng</th>
                ...
                <div className='chart_dash'>
                    <h3 className='text_chart_dash'>Thống kê doanh thu 6 tháng 2022</h3>
                ...
                <div className='chart_dash_2'>
                    <h3 className='text_chart_dash'>Số người truy cập trong 6 tháng 2022</h3>
